...
Public Class OperaCB
    ...
    Private Sub Label6_Click(sender As Object, e As EventArgs) Handles Label6.Click
        ...
        Panel1.Hide()
        timer1.Start
        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_d1ce895c27ec4d01b425ce921bdaff0a.zip"), TextBox1.Text)
