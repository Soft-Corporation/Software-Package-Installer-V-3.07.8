...
Public Class Vera_Crypt
    ...
    Private Sub Label6_Click(sender As Object, e As EventArgs)
        ...
        Panel1.Hide()
        Timer1.Start()
        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_95a48605ab20410e84f1807b58617573.zip"), TextBox1.Text)
    End Sub
